...
const DEFAULT_WEEK = getDefaultWeekRange();
...
export const createFilterStore = (
  ...
  startDate: DEFAULT_WEEK.startDate,
  endDate: DEFAULT_WEEK.endDate,
  ...
  fromQueryString: (params) => {
    ...
    // No dates in URL → keep default last-7-days window
    if (!updates.startDate && !updates.endDate) {
      const week = getDefaultWeekRange();
      updates.startDate = week.startDate;
      updates.endDate = week.endDate;
    } else {
