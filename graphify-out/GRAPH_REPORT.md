# Graph Report - Defence Poc  (2026-07-11)

## Corpus Check
- 141 files · ~50,015 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 943 nodes · 1827 edges · 49 communities (38 shown, 11 thin omitted)
...
7. `buildCategoryFromClause()` - 14 edges
8. `serializeApiTimestamps()` - 14 edges
9. `buildExpandedSelect()` - 14 edges
10. `qTable()` - 13 edges
...
- `getLucknowConstituency()` --calls--> `queryConstituencyMediaCounts()`  [EXTRACTED]
  backend/src/controllers/constituency.controller.ts → backend/src/services/excel/constituency-query.ts
...
Cohesion: 0.08
Nodes (40): parseNewsFilters(), parseNewsFiltersFromBody(), getEntityAnalytics(), parseNewsFiltersFromQuery(), buildPdfResponse(), exportPdfGet(), exportPdfPost(), parseNewsIds() (+32 more)

### Community 1 - "UI Primitives & Utils"
Cohesion: 0.07
Nodes (46): AnalyticsCard, AnalyticsCardProps, KpiCardVariant, VARIANT_STYLES, ChartContainer, ChartContainerProps, MediaColumnProps, entityKpisFromAnalytics() (+38 more)

### Community 2 - "Excel API Routes"
Cohesion: 0.06
Nodes (42): DetailModal(), DetailModalProps, EmptyState(), EmptyStateProps, ExportButton, ExportButtonProps, applyDateRangeChange(), clampToToday() (+34 more)

### Community 3 - "Entity Pages & Shell"
Cohesion: 0.11
Nodes (20): KpiGrid, KpiGridProps, BarChartProps, chartTheme, EntityDoughnutChart, EntityDoughnutProps, HorizontalBarChart, HorizontalBarProps (+12 more)
...
Cohesion: 0.09
Nodes (21): DateRangeInput(), DateRangeInputProps, stepAccent, urgencySoft, urgencyTone, entityFromPathname(), FilterBar(), useDebouncedValue() (+13 more)
...
Cohesion: 0.22
Nodes (18): EntityDashboardProps, LucknowMediaTab(), MEDIA_TABS, OverviewMediaSearchTab(), buildQuery(), buildQueryString(), useEntityDashboard(), useLucknowConstituencyNews() (+10 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (95): getPool(), buildCsv(), buildXlsx(), exportData(), parseNewsIds(), buildCategoryFromClause(), constituencyExistsExpr(), entityCategoryExpr() (+87 more)
...
Cohesion: 0.17
Nodes (8): EntityDashboard, DefenceMinisterPage, ENTITY_PAGES, IndianAirForcePage, IndianArmyPage, IndianCoastGuardPage, IndianNavyPage, StickyFilterBar()

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (35): api, ApiRequestOptions, buildUrl(), maybeRedirectOnUnauthorized(), mergeSignals(), parseError(), QueryParams, request() (+27 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (51): createSessionToken(), getSecret(), getSessionUserId(), sessionCookieOptions(), signPayload(), verifySessionToken(), authenticateUser(), AuthUser (+43 more)
...
Cohesion: 0.16
Nodes (7): LoadingSkeleton(), PageSkeleton(), LucknowConstituencyDashboard, OverviewDashboard, PerceptionRecommendationDashboard, Header(), HeaderProps
...
Cohesion: 0.33
Nodes (7): FilterFieldsProps, createFilterStore(), DEFAULT_WEEK, FILTER_KEYS, FilterState, FilterStore, FilterStore
...
## Knowledge Gaps
- **321 isolated node(s):** `PreToolUse`, `name`, `version`, `private`, `description` (+316 more)
...
- **Why does `MediaColumnProps` connect `UI Primitives & Utils` to `Community 11`, `Entity Pages & Shell`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `HorizontalBarChart` connect `Entity Pages & Shell` to `UI Primitives & Utils`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `queryOverviewAnalytics()` connect `Community 12` to `Charts & Visualization`, `Community 18`?**
